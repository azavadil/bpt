module.exports = function(config, mongoose, nodemailer) {
    ...
    var BetSchema = new mongoose.Schema({
      ...
      counterpartyAccept: { type: Boolean, default: false },
      counterpartyReject: { type: Boolean, default: false }, 
      authorTeAccept: {type: Boolean, default: false }, 
      counterpartyTeAccept: {type: Boolean, default: false}, 
      authorValidation : { type: Boolean, default: false },  
      counterpartyValidation: { type: Boolean, default: false },
      pendingInitialApproval: {type: Boolean, default: true},
      pendingTe: {type: Boolean, default: false}, 
      pendingWinner: {type: Boolean, default: false}, 
      openBet: {type: Boolean, default: false}, 
      closedBet: {type: Boolean, default: false}, 
